...
Shared with sim/head.py -- keep the two in step. The simulator exists to
predict what this does on the node; if they diverge the simulator stops
...
from src.federated.features import N_CLASSES, N_FEATURES
